...
# bash: template <args> 
#
# Will then do DESCRIPTION
#
# OTHER INFO AND DESCRIPTION
#
# This template file is based on renaming audio files using their metadata, and takes on argument, the directory to find files.
